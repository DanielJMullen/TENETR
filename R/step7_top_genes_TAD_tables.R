...
step7_top_genes_TAD_tables <- function(
  ...
  if(
    ...
    stop("No TAD/ subdirectory found in the main level of the specified TENET directory. Please create such a folder containing bed-like files with topologically associating domains information, or check that an existing subdirectory is named as 'TAD'")
  }
